...
package uk.gov.dbt.ndtp.jena.graphql.schemas.ianode.graph;
...
/**
 * Constants relating to the GraphQL Schema used by the IANode Graph application
 */
public class IANodeGraphSchema {

    private IANodeGraphSchema() {}
    /**
     * The classpath resource that contains the GraphQL schema file
     */
    public static final String SCHEMA_RESOURCE =
            "/uk/gov/dbt/ndtp/jena/graphql/schemas/ianode/graph/ies.graphqls";
     ...
     */
    public static TypeDefinitionRegistry loadIANodeGraphSchema() throws IOException {
    ...
    /**
     * Search term argument used to specify the search term passed onto IANode Search API
     */
    public static final String ARGUMENT_SEARCH_TERM = "searchTerm";
    /**
     * Search type arguments used to specify the type of search used for the IANode Search API
     */
    ...
    /**
     * Type filter argument used to specify a type filter for the IANode Search API
     */
     ...
     * {@link graphql.schema.DataFetcher} instances when they need to query other IANode services
     */
