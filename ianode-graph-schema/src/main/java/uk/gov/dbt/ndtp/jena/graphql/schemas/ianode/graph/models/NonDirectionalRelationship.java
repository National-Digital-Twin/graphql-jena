...
public class NonDirectionalRelationship {
    ...
    private final IANodeGraphNode predicate, entity;
     ...
     * @param entity    Entity
     */
    public NonDirectionalRelationship(IANodeGraphNode predicate, IANodeGraphNode entity) {
     ...
     * @return Entity
     */
    public IANodeGraphNode getEntity() {
        return this.entity;
    }
}
