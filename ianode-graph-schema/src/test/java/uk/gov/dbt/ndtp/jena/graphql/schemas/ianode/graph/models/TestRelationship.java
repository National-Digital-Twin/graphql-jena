...
public class TestRelationship {
    ...
    public void test_getID() {
        // given
        IANodeGraphNode subject = new IANodeGraphNode(Node.ANY, null);
        IANodeGraphNode predicate = new IANodeGraphNode(Node.ANY, null);
        IANodeGraphNode object = new IANodeGraphNode(Node.ANY, null);
