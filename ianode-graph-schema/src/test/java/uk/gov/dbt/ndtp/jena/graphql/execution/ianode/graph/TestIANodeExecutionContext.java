...
public class TestIANodeExecutionContext {
    ...
    public void test_nullAuthToken() {
        // given
        IANodeExecutionContext context = new IANodeExecutionContext(DatasetGraphFactory.empty(), null);
        // when
    ...
    public void test_emptyAuthToken() {
        // given
        IANodeExecutionContext context = new IANodeExecutionContext(DatasetGraphFactory.empty(), "");
        // when
        boolean actual = context.hasAuthToken();
        // then
        Assert.assertFalse(actual);
    ...
    public void test_nonNullAuthToken() {
        // given
        IANodeExecutionContext context = new IANodeExecutionContext(DatasetGraphFactory.empty(), RANDOM_STRING);
        // when
        boolean actual = context.hasAuthToken();
        // then
