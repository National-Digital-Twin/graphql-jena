...
public class TestGraphQLRequest {
    @Test
    public void test_setOperationAndVariables() {
        // given
       GraphQLRequest graphQLRequest = new GraphQLRequest();
        // when
        graphQLRequest.setOperationName(UtilConstants.RANDOM_ID);
        graphQLRequest.setVariables(Collections.emptyMap());
        graphQLRequest.setExtensions(Collections.emptyMap());
        // then
        Assert.assertEquals(UtilConstants.RANDOM_ID, graphQLRequest.getOperationName());
