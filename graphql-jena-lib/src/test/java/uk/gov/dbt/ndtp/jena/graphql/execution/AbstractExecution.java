...
public class AbstractExecution {
    ...
    protected static GraphQLRequest loadRequest(String requestBase, String requestResource) {
        try (InputStream input = AbstractExecution.class.getResourceAsStream(requestBase + requestResource)) {
            if (input == null) {
     ...
     */
    protected static ExecutionResult verifyExecution(
            GraphQLExecutor execution, String query) {
     ...
     */
    protected static ExecutionResult verifyExecution(
        GraphQLExecutor execution, GraphQLRequest request) {
     ...
     */
    protected static ParseAndValidateResult verifyValidationSuccess(
        GraphQLExecutor execution, String query) {
     ...
     * @return Validation result
     */
    protected static ParseAndValidateResult verifyValidationFailure(
        GraphQLExecutor execution, String query) {
